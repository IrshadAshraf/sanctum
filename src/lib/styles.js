export const container =
  "mx-auto w-[min(1298px,calc(100%_-_48px))] max-sm:w-[min(100%_-_28px,560px)]";
...
export const button =
  "inline-flex min-h-12 items-center justify-center gap-2.5 whitespace-nowrap rounded-full border border-transparent px-4 sm:px-7 text-[0.95rem] font-bold transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.03] hover:shadow-[0_0_28px_rgba(210,175,105,0.55),0_14px_34px_rgba(0,0,0,0.32)] focus-visible:shadow-[0_0_28px_rgba(210,175,105,0.55)]";
...
export const kicker =
  "flex items-center gap-4 text-[0.82rem] font-bold uppercase tracking-[0.38em] text-[#d2af69]";
...
export const avatarStack =
  "flex items-center [&>img]:-ml-2.5 [&>img:first-child]:ml-0 [&>img]:size-7 [&>img]:rounded-full [&>img]:border-2 [&>img]:border-white [&>img]:object-cover";
